...
declare module '$env/static/private' {
	export const VITE_USE_MOCKS_POWERFIN: string;
	export const VITE_USE_MOCKS_BRIDGE: string;
	export const LESSOPEN: string;
	export const ORCA_OMP_CODING_AGENT_DIR: string;
	...
	export const PI_CODING_AGENT_DIR: string;
	...
	export const ORCA_OMP_STATUS_EXTENSION: string;
	...
	export const ORCA_PI_CODING_AGENT_DIR: string;
	export const LC_NUMERIC: string;
	export const npm_command: string;
	export const LC_PAPER: string;
	export const ORCA_CODEX_HOME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		VITE_USE_MOCKS_POWERFIN: string;
		VITE_USE_MOCKS_BRIDGE: string;
		LESSOPEN: string;
		ORCA_OMP_CODING_AGENT_DIR: string;
		LANGUAGE: string;
		CODEX_HOME: string;
		USER: string;
		LC_TIME: string;
		...
		ORCA_OMP_STATUS_EXTENSION: string;
		...
		M2_HOME: string;
		ORCA_PI_CODING_AGENT_DIR: string;
		LC_NUMERIC: string;
		npm_command: string;
		LC_PAPER: string;
